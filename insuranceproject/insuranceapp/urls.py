...
urlpatterns = [
    ...
    path("insurance-product/select/<int:policyholder_id>/", views.insurance_product_select, name="insurance-product-select"),
    ...
    path("homeinsurance/create/<int:policyholder_id>/", views.HomeInsuranceCreateView.as_view(), name="homeinsurance-create"),
    path("homeinsurance/detail/<int:pk>/", views.HomeInsuranceDetailView.as_view(), name="homeinsurance-detail"),
    path("homeinsurance/update/<int:pk>/", views.HomeInsuranceUpdateView.as_view(), name="homeinsurance-update"),
    path("homeinsurance/delete/<int:pk>/", views.HomeInsuranceDeleteView.as_view(), name="homeinsurance-delete"),
]
